<?php
// undo_inactive.php - Improved version with activity logging
...
try {
    ...
    // Log the activity
    $logger->log('UNDO_INACTIVE', "Restored senior from inactive to active status", [
        'applicant_id' => $id,
    ...
    // Log error
    if ($logger) {
        $logger->log('ERROR', 'Failed to restore senior from inactive status', [
            'applicant_id' => $id,
