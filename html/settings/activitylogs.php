...
<head>
    ...
    <style>
        ...
        .nav-list li #activity.active-link {
            color: #1d4ed8;
            /* Tailwind blue-700 */
            font-weight: 600;
            border-color: #1d4ed8;
        ...
        .nav-list li #activity.active-link svg {
            color: #1d4ed8;
        }
    </style>
</head>
            ...
            <div class="flex flex-row justify-between gap-2">
                ...
                <div class="sidebar open">
                    ...
                    <ul class="nav-list">
                        ...
                        <li>
                            <a href="#" id="activity" class="cursor-pointer active-link">
                                <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                    viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                ...
                <!-- activity log  -->
                <section id="activitySection" class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 w-full ">
