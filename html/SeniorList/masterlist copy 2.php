...
try {
    ...
    if (!empty($filtered_barangays)) {
        ...
        $where_conditions[] = "a.barangay IN ($barangay_placeholders)";
...
<body class="bg-gray-50 dark:bg-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <!-- Hidden field to store selected barangays for form submission -->
                                <input type="hidden" name="barangays_hidden" id="barangaysHidden"
                                    value="<?php echo htmlspecialchars(implode(',', $filtered_barangays)); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-xl font-semibold text-gray-900 dark:text-white">
                                <?php
                                // This would require an additional query in real implementation
                                echo $total_records; // Placeholder
                                ?>
                            </p>
                        </div>
                    </div>
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <?php foreach ($seniors_data as $senior):
                                    ...
                                    $total_columns = 121; // Count of all table columns
                                ?>
                                    <tr>
                                        <!-- Province (2 columns, rowspan 4) -->
                                        <td colspan="2" rowspan="4"><?php echo formatEmpty($basic['province']); ?></td>

                                        <!-- Municipality (2 columns, rowspan 4) -->
                                        <td colspan="2" rowspan="4"><?php echo formatEmpty($basic['municipality']); ?></td>

                                        <!-- Barangay (2 columns, rowspan 4) -->
                                        <td colspan="2" rowspan="4"><?php echo formatEmpty($basic['barangay']); ?></td>
                                        ...
                                        <td rowspan="4"><?php echo formatEmpty($basic['local_control_number']); ?></td>
                                        ...
                                        <td rowspan="4"><?php echo formatEmpty($basic['status']); ?></td>
                                        ...
                                        <td rowspan="4"><?php echo formatEmpty($basic['ip_group']); ?></td>

                                        <!-- Educational Attainment (1 column, rowspan 4) -->
                                        <td rowspan="4"><?php echo formatEmpty($basic['educational_attainment']); ?></td>
                                        ...
                                        <td rowspan="4"><?php echo $senior['monthly_income']; ?></td>
                                    ...
                                    <!-- Add 3 more rows for the rowspan=4 cells -->
                                    <tr>
                                        <!-- These cells are already covered by rowspan -->
                                        <td><?php echo formatEmpty($basic['last_name']); ?></td>
                                        <td><?php echo formatEmpty($basic['suffix']); ?></td>
                                        <td><?php echo formatEmpty($basic['first_name']); ?></td>
                                        <td><?php echo formatEmpty($basic['middle_name']); ?></td>
                                    ...
                                    <!-- Repeat for rows 3 and 4 if needed, but typically you'd have different data for each row -->
                                    <tr>
                                        <!-- Repeat the same pattern for row 3 -->
                                        <!-- ... -->
                                    </tr>
                                    <tr>
                                        <!-- Repeat the same pattern for row 4 -->
                                        <!-- ... -->
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.auto-filter').forEach(cb => {
        ...
        function exportToExcel() {
            try {
                // Get table data
                const table = document.querySelector('.demographic-table');
                ...
                XLSX.utils.book_append_sheet(wb, ws, 'Demographic Data');
