...
<head>
    ...
    <title>Senior - Deceased List</title>
    <!-- Favicon -->
                        ...
                        <ul id="dropdown-pages" class=" py-2 space-y-2">
                            ...
                            <li>
                                <a href="#"
                                    ...
                                    <i class="fas fa-cross mr-2 text-sm text-blue-700 dark:text-white group-hover:text-blue-800 dark:group-hover:text-white"></i>Deceased List
                                </a>
                            </li>
                        </ul>
                    </li>
        ...
        `;
            ...
            window.undoDeceased = async (id, name) => {
                ...
                try {
                    ...
                    // Add context parameter to the URL
                    const url = `/MSWDPALUAN_SYSTEM-MAIN/php/deceasedlist/undo_deceased.php?id=${id}`;
                    const contextUrl = isStaffPage ?
                        `${url}&session_context=staff` :
                        `${url}&session_context=admin`;

                    console.log(`📤 Sending undo deceased request as ${isStaffPage ? 'staff' : 'admin'}`);
