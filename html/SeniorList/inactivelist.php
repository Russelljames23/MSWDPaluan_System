                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        ...
                        <ul id="dropdown-pages" class="py-2 space-y-2">
                            ...
                            <li>
                                <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-medium text-blue-700 rounded-lg dark:text-white bg-blue-100 hover:bg-blue-200 dark:bg-blue-700 dark:hover:bg-blue-600 group">Inactive
                                    List</a>
                            </li>
                            <li>
    ...
    <script>
        ...
        `;
            ...
            function fetchDeceased() {
                ...
                fetch(`../../php/inactivelist/fetch_inactive.php?${params}`)
                    .then(res => res.json())
                    .then(data => {
                        tbody.innerHTML = "";
            ...
            window.undoDeceased = async (id, name) => {
                ...
                if (!confirm) return;
                try {
                    const res = await fetch(`../../php/inactivelist/undo_inactive.php?id=${id}`, {
                        method: "POST"
                    });
