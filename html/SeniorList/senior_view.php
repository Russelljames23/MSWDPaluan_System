...
<head>
    ...
    <!-- Updated Title with Applicant's Name -->
...
<body class="bg-gray-50 dark:bg-gray-900">
                ...
                <div class="relative">
                    ...
                    <div id="actionDropdown"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                            ...
                            <li>
                                <a href="#" onclick="return printApplicationForm()"
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
            ...
            <form action="">
                <div class="print-ready">
                    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
                        <div class="flex flex-col  items-center w-full px-20 py-10">
    ...
    <script>
        // Simple print function that works with your existing form
        function printApplicationForm() {
            ...
            style.innerHTML = `
                ...
                /* Make checkmarks visible before printing */
