                ...
                if ($econ_exists) {
                    $stmt = $pdo->prepare("
                        UPDATE economic_status SET 
                            ...
                            has_sss = ?, has_gsis = ?, has_pvao = ?, has_insurance = ?,
                            has_tin = ?, has_philhealth = ?, support_type = ?, support_cash = ?, support_in_kind = ?
                        WHERE applicant_id = ?
                    ");
                    $stmt->execute([
                    ...
                    $stmt = $pdo->prepare("
                        ...
                        (applicant_id, is_pensioner, pension_source, pension_source_other, pension_amount,
                         has_permanent_income, has_family_support, income_source, income_source_detail,
                         monthly_income, assets_properties, living_residing_with,
                         has_sss, has_gsis, has_pvao, has_insurance, has_tin, has_philhealth,
