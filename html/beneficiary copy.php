    ...
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <main class="p-4 md:ml-64 pt-20 flex flex-col" >
            ...
            <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
                <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                        <div>
                            <p class="text-2xl font-semibold px-5 mt-5 text-gray-900 dark:text-white">Beneficiaries</p>
                        </div>
                        <div
                            ...
                            <div
                                ...
                                <button type="button" id="defaultModalButton1" data-modal-target="defaultModal1"
                                    data-modal-toggle="defaultModal1" class=" flex items-center justify-center cursor-pointer text-white bg-blue-700
                            ...
                            <table id="deceasedTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead class="text-xs text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-15 py-3">Age</th>
                                ...
                                <tbody>
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">Aguilar, Lourdes</td>
                                        <td class="px-4 py-3">65</td>
                                        <td class="px-0.5py-4">II - Handang Tumulong</td>
                                        <td class="px-0.5py-4">Female</td>
                                        <td class="px-0.5py-4">Validated</td>
                                        <td class="px-0.5py-4">
                                            <button href="#"
            ...
            <div id="defaultModal1" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative p-4 w-100 max-w-xl h-full md:h-auto">
                    <!-- Modal content -->
                            ...
                            <div class="grid gap-4 mb-4 sm:grid-cols-1">
                                <div>
                                    <select id="Benefits"
                                        ...
                                        <option value="TV">Availed of Social Pension</option>
                                        <option value="PC">Availed of Birthday Gift </option>
                                        <option value="GA">Availed of OSCA ID</option>
                                        <option value="PH">Availed of Centenarian Awardee</option>
                                    </select>
                                </div>
                                <div class="">
                                    <label for="date"
                    ...
                    <div>
                        ...
                        <button type="button" id="defaultModalButton2" data-modal-target="defaultModal2"
                            data-modal-toggle="defaultModal2" class=" flex items-center justify-center cursor-pointer text-white bg-blue-700
                                    hover:bg-blue-800 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600
                                    dark:hover:bg-blue-700" style="margin-left: 250px;">
                            <svg class="mr-1 -ml-1 w-4 h-6" fill="currentColor" viewbox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path clip-rule="evenodd" fill-rule="evenodd"
                                    d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" />
                            </svg>
                        ...
                        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                            <div
                                ...
                                <div class="relative w-full md:w-auto">
                                    <!-- Filter Button -->
                                    <button id="filterDropdownButtons"
           ...
           01-.293.707L12 11.414V15a1 1 0 
           01-.293.707l-2 2A1 1 0 018 17v-5.586L3.293 
           6.707A1 1 0 013 6V3z" clip-rule="evenodd" />
                        ...
                        <div
                            class="overflow-x-auto bg-white dark:bg-gray-900 relative shadow-md sm:rounded-lg overflow-hidden mt-6">
                            <h3 class="text-12px font-normal text-gray-900 dark:text-white px-5">
                            ...
                            <table id="deceasedTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead class="text-xs text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        <th scope="col" class="px-4 py-3">No.</th>
                                        <th scope="col" class="px-15 py-3">Name</th>
                                        <th scope="col" class="px-15 py-3">Benefits</th>
                                ...
                                <tbody>
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-0.5py-4">12/27/2001</td>
