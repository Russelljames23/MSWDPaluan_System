    ...
    <nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                <button onclick="toggleSidebar()" aria-controls="drawer-navigation"
            ...
            <div class="flex items-center lg:order-2 space-x-4">
                ...
                <!-- ... rest of user profile code remains the same ... -->
            </div>
        </div>
    </nav>
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="flex space-x-2">
                    <button onclick="window.print()"
                        ...
                        data-tooltip="Print Dashboard">
                        <i class="fas fa-print mr-2"></i>Print
                    </button>
                    <a href="./reports/report.php?session_context=<?php echo $ctx; ?>"
                        class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800"
                        data-tooltip="Generate Detailed Report">
