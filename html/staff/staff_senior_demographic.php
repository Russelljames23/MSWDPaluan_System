        ...
        <main class="p-4 md:ml-64 pt-20">
            ...
            <div class="w-full flex justify-between items-center mb-6 no-print">
                ...
                <div class="flex items-center space-x-4">
                    <a href="staff_senior_view.php?session_context=<?php echo $ctx; ?>&id=<?php echo $applicant_id; ?>"
                ...
                <div class="relative">
                    ...
                    <div id="actionDropdown"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                            <li>
                                <a href="staff_senior_edit.php?session_context=<?php echo $ctx; ?>&id=<?php echo $applicant_id; ?>"
            ...
            <div class="mb-6">
                ...
                <div class="bg-white dark:bg-gray-800 font-normal rounded-lg shadow-sm p-4 border border-gray-200 dark:text-white dark:border-gray-700 overflow-x-auto">
