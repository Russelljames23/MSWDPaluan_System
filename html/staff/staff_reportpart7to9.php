...
<head>
    ...
    <title>Report Part - VII-IX</title>
    <!-- Favicon -->
...
<body class="bg-gray-50 dark:bg-gray-900">
                ...
                <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                        ...
                        <div class="overflow-x-auto p-4">
                            <!-- Part VII: PhilHealth Registrations -->
                            <div class="w-full mb-8 gap-2 flex flex-col">
                                <h4 class="text-lg font-medium dark:text-white mb-4"
                                    style="font-family: 'Times New Roman', Times, serif;">
                                    VII. Number of Senior Citizens who Registered to PhilHealth for the Month
                                </h4>
                                <div class="flex flex-wrap gap-6 items-center">
                                    <div class="border border-gray-300 dark:border-gray-600 shadow shadow-gray-300 drop-shadow-sm p-4 flex bg-sky-100 dark:bg-sky-900 w-48 h-24 rounded-lg items-center justify-center">
                            ...
                            <!-- Part VIII: Purchase Booklets -->
                            <div class="w-full gap-2 flex flex-col mb-8">
                                <h4 class="text-lg font-medium dark:text-white mb-4"
                                    style="font-family: 'Times New Roman', Times, serif;">
                                    VIII. Total Number of Released Purchase Booklets
                                </h4>
                                <div class="flex flex-wrap gap-6 items-center">
                                    <div class="border border-gray-300 dark:border-gray-600 shadow shadow-gray-300 drop-shadow-sm p-4 flex bg-green-100 dark:bg-green-900 w-48 h-24 rounded-lg items-center justify-center">
                            ...
                            <div class="w-full gap-2 flex flex-col">
                                ...
                                <!-- Add Activity Form -->
                                <form id="activityForm" class="mb-6">
                                    <div class="flex flex-row gap-5 w-full items-center px-2 mb-4">
                                        <div class="w-full">
                                            <input type="text" id="activityInput"
                                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Type activity description here" required />
                                        </div>
                                        <div class="w-auto">
                                            <button type="submit"
                                ...
                                <div class="px-2 w-full">
                                    ...
                                    <div class="mb-4">
                                        <ul id="activitiesList"
                                            class="overflow-y-auto max-h-60 space-y-2 text-gray-700 list-disc list-inside bg-gray-50 border border-gray-300 text-sm rounded-lg p-4 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    ...
                                    <div class="flex justify-between items-center text-sm text-gray-600 dark:text-gray-400">
                                        <span>Total Activities: <span id="activitiesCount" class="font-semibold">0</span></span>
    ...
    <script>
        ...
        window.part3 = function() {
            navigateToReport('staff_reportpart3.php');
        };
        ...
        window.part7to9 = function() {
            // Already on part 7-9, reload with current filters
        ...
        // Part VII-IX specific functions
        (function() {
            'use strict';

            console.log('Part VII-IX page initialized');
            ...
            document.addEventListener('DOMContentLoaded', function() {
                console.log('DOM loaded. Loading Part VII-IX data...');
                loadStatistics();
                loadActivities();
                setupEventListeners();
            });
            ...
            // Main function to load statistics
            async function loadStatistics() {
                try {
                    ...
                    if (result.success) {
                        ...
                        populateYearFilter(result.available_years || []);
                    } else {
            ...
            function displayStatistics(data) {
                ...
                const philhealthCount = document.getElementById('philhealthCount');
                if (philhealthCount) {
                    philhealthCount.textContent = data.philhealth_count || 0;
                }

                // Update booklets count
                const bookletsCount = document.getElementById('bookletsCount');
                if (bookletsCount) {
                    bookletsCount.textContent = data.booklets_count || 0;
                }
                ...
                if (dataUpdated) {
                    dataUpdated.textContent = timeString;
                }
            ...
            function displayActivities(activities) {
                ...
                // Create list items for each activity
                activities.forEach((activity, index) => {
                    const li = document.createElement('li');
                    li.className = 'flex justify-between items-start p-2 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-600 rounded';

                    const activityText = document.createElement('span');
                    activityText.className = 'flex-1';
                    activityText.textContent = `${index + 1}. ${activity.description}`;

                    const deleteBtn = document.createElement('button');
                    deleteBtn.className = 'ml-2 text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300';
            ...
            async function addActivity() {
                ...
                try {
                    ...
                    formData.append('description', activityInput.value.trim());
                    formData.append('month', currentMonth || new Date().getMonth() + 1);
                    formData.append('year', currentYear || new Date().getFullYear());
            ...
            async function clearAllActivities() {
                ...
                try {
                    const formData = new FormData();
                    formData.append('action', 'clear_activities');
                    formData.append('month', currentMonth || new Date().getMonth() + 1);
                    formData.append('year', currentYear || new Date().getFullYear());
            ...
            function populateYearFilter(years) {
                ...
                const allYearsItem = yearList.querySelector('li:first-child');
                yearList.innerHTML = '';
                if (allYearsItem) yearList.appendChild(allYearsItem);
            ...
            function showLoading() {
                // Update counts to show loading
                const counts = ['philhealthCount', 'bookletsCount'];
                counts.forEach(id => {
