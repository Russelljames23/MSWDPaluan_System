...
$minBirthDate->modify('-60 years'); // Subtract 60 years
...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <script>
        ...
        function validateNameInput(input, fieldName) {
            ...
            // For first name and last name - require at least one character
        ...
        // Validate date format and perform actions
