...
<body class="bg-gray-50 dark:bg-gray-900">
                    ...
                    <div class="hidden z-50 my-4 w-56 text-base list-none bg-white divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                        ...
                        <div class="py-3 px-4">
                            ...
                            <span class="block text-sm text-gray-900 truncate dark:text-white">
                                <?php echo htmlspecialchars($user_data['user_type'] ?? 'User Type'); ?>
                            </span>
                        </div>
    ...
    <script>
        ...
        (function() {
            // Unique namespace for staff theme functions
            const StaffTheme = {
            ...
            // Initialize staff theme immediately
            StaffTheme.init();

            // Set up event listeners for staff theme toggle
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Listen for storage events (staff theme only)
            ...
            // Make StaffTheme globally available for staff pages only
