            ...
            <main class="p-4 md:ml-64 pt-20">
                ...
                <div class="w-full flex justify-between items-center mb-6 no-print">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="staff_senior_demographic.php?session_context=<?php echo $ctx; ?>&id=<?php echo htmlspecialchars($_GET['id'] ?? ''); ?>"
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                async function loadApplicant() {
                    try {
                        ...
                        const res = await fetch(`/MSWDPALUAN_SYSTEM-MAIN/php/seniorlist/senior_edit.php?id=${encodeURIComponent(applicantId)}&session_context=staff&staff_user_id=${staffUserId}`);
                ...
                window.submitForm = async function() {
                    ...
                    // Add staff context - IMPORTANT!
                    fd.append('session_context', 'staff');
                    fd.append('staff_user_id', <?php echo json_encode($_SESSION['staff_user_id'] ?? $_SESSION['user_id'] ?? 0); ?>);
                    fd.append('staff_user_name', <?php echo json_encode($_SESSION['fullname'] ?? $_SESSION['username'] ?? 'Staff'); ?>);
