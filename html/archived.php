                ...
                <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                    <li>
                        <a href="#" style="color: blue;"
                            class="flex items-center p-2 text-base font-medium text-blue-700 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            async function fetchArchived() {
                try {
                    ...
                    <td class="px-2 py-1 text-red-600">${row.validation}</td>
